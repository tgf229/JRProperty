...
@interface HomFragmentController : JRViewController<UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate,EScrollerViewDelegate>
...
@property (weak,nonatomic) IBOutlet UIView *serviceListView;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *serviceListHeightConstraint;
