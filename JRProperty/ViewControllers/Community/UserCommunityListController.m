...
@interface UserCommunityListController ()
...
@implementation UserCommunityListController
...
//    self.dict = [[NSMutableDictionary alloc]init];
    ...
    __weak UserCommunityListController *weakCommunityListController = self;
...
-(void)reqList:(NSString *)page time:(NSString *)queryTime{
    ...
    [self.communityService Bus301402:CID_FOR_REQUEST uId:uId queryUId:uId page:page num:NUMBER_FOR_REQUEST queryTime:queryTime success:^(id responseObject) {
