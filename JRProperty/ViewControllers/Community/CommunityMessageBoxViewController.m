//
//  CommunityMessageBoxViewController.m
//  JRProperty
//
//  Created by YMDQ on 16/1/7.
//  Copyright © 2016年 YRYZY. All rights reserved.
//

#import "CommunityMessageBoxViewController.h"
...
@interface CommunityMessageBoxViewController ()
@property (weak, nonatomic) IBOutlet UITableView *communityMessageBoxTableView;
...
@implementation CommunityMessageBoxViewController
...
-(void)requestMyMessageBoxFromDatabase{
    ...
    NSMutableArray * unReadMessages = [[MessageDataManager defaultManager] queryMyMessageBox:[LoginManager shareInstance].loginAccountInfo.uId isRead:@"0" type:@"3"];
    NSMutableArray * readMessages = [[MessageDataManager defaultManager] queryMyMessageBox:[LoginManager shareInstance].loginAccountInfo.uId isRead:@"1" type:@"3"];
    [self.dataSourceArray removeAllObjects];
    [self.dataSourceArray addObjectsFromArray:unReadMessages];
    [self.dataSourceArray addObjectsFromArray:readMessages];
    [self.communityMessageBoxTableView reloadData];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    MyMessageBoxTableViewCell * myMessageBoxTableViewCell = [tableView dequeueReusableCellWithIdentifier:@"myCoMessageBoxTableViewCell"];
    //初始化表格cell控件元素
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch ([myMessageBoxModel.type integerValue]) {
        ...
        case 3:{
            ...
            controller.articleId = myMessageBoxModel.aId;
